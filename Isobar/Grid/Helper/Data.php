...
{
    const XML_PATH_ENABLED      = 'sample/general/enable_in_frontend';
    const XML_PATH_HEAD_TITLE   = 'sample/general/head_title';
    const XML_PATH_LASTEST_NEWS = 'sample/general/lastest_news_block_position';
